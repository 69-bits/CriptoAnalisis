...
public:
    ...
    /* * Funci�n para codificar un texto utilizando XOR con una clave.
   * @param input: El texto a codificar.
   * @param key: La clave para la codificaci�n.
   ...
   */
    ...
    /* * Funci�n para decodificar un texto codificado con XOR utilizando la misma clave.
   * @param input: El texto codificado.
   * @param key: La clave para la decodificaci�n.
   ...
   */
    ...
    /* * Funci�n para imprimir un texto en formato hexadecimal.
   ...
   */
    ...
    /* * Funci�n para verificar si un texto es v�lido.
   ...
   */
    ...
    /* * Funci�n para realizar un ataque de fuerza bruta al cifrado XOR con clave de 2 bytes.
   * @param cifrado: El texto cifrado a descifrar.
   * Esta funci�n intenta todas las combinaciones de claves de 2 bytes (0-255) y muestra los resultados.
   *
   * Ejemplo:
   ...
   */
    ...
    /* * Funci�n para realizar un ataque de fuerza bruta al cifrado XOR utilizando un diccionario de claves comunes.
   * @param cifrado: El texto cifrado a descifrar.
   * Esta funci�n intenta descifrar el texto utilizando una lista de claves comunes y muestra los resultados.
   *
   * Ejemplo:
   * std::vector<unsigned char> bytesCifrados = { ... };
